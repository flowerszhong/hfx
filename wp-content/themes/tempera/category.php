...
echo '<a href="' . get_bloginfo('url') . '"><i class="icon-homebread"></i></a>' . $separator . single_cat_title('', false);
echo "</div>";
...
<?php if ($tempera_pagination == "Enable") {tempera_pagination();
} else {tempera_content_nav('nav-below');
}
?>
