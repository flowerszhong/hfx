...
// Area 11, the presentation page columns
	...
	register_sidebar(array(
		'name' => __('系部要闻', 'tempera'),
		'id' => 'custom_cat_1',
		'description' => "设置文章类别",
		'before_widget' => '<div id="%1$s" class="custom-widget-container first-widget %2$s">',
		'after_widget' => '</div>',
		'before_title' => '<h3 class="custom-widget-title"><span>',
		'after_title' => '</span></h3>',
	));

	register_sidebar(array(
		'name' => __('通知公告', 'tempera'),
		'id' => 'custom_cat_2',
		'description' => "设置文章类别",
		'before_widget' => '<div id="%1$s" class="custom-widget-container mid-widget %2$s">',
		'after_widget' => '</div>',
		'before_title' => '<h3 class="custom-widget-title"><span>',
		'after_title' => '</span></h3>',
	));
	...
	register_sidebar(array(
		'name' => __('学生活动', 'tempera'),
		'id' => 'custom_cat_3',
		'description' => "设置文章类别",
		'before_widget' => '<div id="%1$s" class="custom-widget-container last-widget %2$s">',
		'after_widget' => '</div>',
		'before_title' => '<h3 class="custom-widget-title"><span>',
		'after_title' => '</span></h3>',
	));
